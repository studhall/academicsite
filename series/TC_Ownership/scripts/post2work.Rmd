...
concatenated_tc_1 <- readRDS(here("series", "TC_Ownership", "data", "clean", "concatenated_tc_1.rds"))
...
# save stable assets used by the public post
purrr::iwalk(
  plots,
  ~ggsave(
    filename = here("series", "TC_Ownership", "output", paste0("payment_", .y, ".png")),
    plot = .x,
    width = 8,
    height = 5,
    dpi = 160
