...
date: 2026-05-01
description: "A practical comparison of standard and multi-outcome synthetic control methods."
tags:
  - econometrics
format:
  html:
...
From there, one can use placebo inference or related work on [t-statistics for SCM](https://arxiv.org/pdf/1812.10820v6).
...
Once this application becomes a working paper, I will post the results here. So far, the substantive conclusions are stable across separate single-outcome SCMs and the two multi-outcome implementations described above.
